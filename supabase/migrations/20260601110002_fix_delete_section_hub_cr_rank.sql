-- Migration: 20260601110002_fix_delete_section_hub_cr_rank
-- Fixes delete_section_hub failing due to cr_rank constraint violation
...
BEGIN
  ...
  SET 
    section_id = NULL,
    role = 'student',
    cr_rank = NULL,  -- CRITICAL FIX: clear cr_rank when role becomes student
    section_roll = NULL,
