...
const DEMO_POLLS: Poll[] = [
  {
    ...
    type: 'anonymous',
    status: 'active',
    closesAt: new Date(Date.now() + 86400000 * 2).toISOString(),
    createdAt: new Date(Date.now() - 3600000 * 6).toISOString(),
    options: [
      { id: 'opt-1', text: 'Saturday 10:00 AM - 11:30 AM', votes: 18 },
      { id: 'opt-2', text: 'Saturday 02:00 PM - 03:30 PM', votes: 9 },
      { id: 'opt-3', text: 'Sunday 11:00 AM - 12:30 PM', votes: 4 },
    ],
    userVotes: ['opt-1'],
    userVote: 'opt-1',
    voterCount: 31,
